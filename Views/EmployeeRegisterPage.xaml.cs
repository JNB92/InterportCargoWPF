...
namespace InterportCargoWPF.Views
{
    public partial class EmployeeRegisterPage : Page
    {
        ...
        private void RegisterButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            string employeeType = EmployeeTypeBox.Text;
            ...
            if (string.IsNullOrWhiteSpace(firstName) || string.IsNullOrWhiteSpace(lastName) ||
                string.IsNullOrWhiteSpace(email) || string.IsNullOrWhiteSpace(employeeId) || string.IsNullOrWhiteSpace(phoneNumber) ||
                string.IsNullOrWhiteSpace(employeeType) || string.IsNullOrWhiteSpace(password))
            {
