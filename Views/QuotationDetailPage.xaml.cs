...
{
    /// <summary>
    /// Represents the details page for a specific quotation, providing functionalities to view, accept, and reject quotations.
    /// </summary>
    public partial class QuotationDetailPage : Page
    {
        ...
        {
            var rejectionReason = Microsoft.VisualBasic.Interaction.InputBox("Enter the reason for rejection:", "Reject Quotation", "Incomplete information");
